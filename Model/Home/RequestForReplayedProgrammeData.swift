//
//  RequestForReplayedProgrammeData.swift
//  WirelessJinan
//
...
extension ReplayedProgrammeModel {
    ...
    class func requestForReplayedProgrammeData(homeUrl:String,callBack:(modelArray:[AnyObject]?,error: NSError?)->Void) {
        ...
        manager.POST(homeUrl, parameters: para, progress: nil, success: { (task, data) in
            ...
            modelArray.addObjectsFromArray(ReplayedProgrammeModel.mj_objectArrayWithKeyValuesArray(obj) as [AnyObject])
            
            callBack(modelArray: modelArray as [AnyObject], error: nil)
